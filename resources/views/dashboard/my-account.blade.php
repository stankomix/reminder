    ...
    <div class="card-body">
        ...
        <form action="#" method="POST">
            ...
            <div class="col-sm-6">
                ...
                <div class="form-group">
                    <input type="text" name="company_name" value="{{ isset($company->name) ? $company->name : '' }}" class="form-control" placeholder="Company Name">
                    <i class="form-group__bar"></i>
                </div>
                
                <div class="form-group">
                    <input type="text" name="phone" value="{{ isset($company->phone) ? $company->phone : '' }}" class="form-control" placeholder="Phone">
                    <i class="form-group__bar"></i>
                </div>
                
                <div class="form-group">
                    <input type="text" name="address" value="{{ isset($company->address) ? $company->address : '' }}" class="form-control" placeholder="Address">
                    <i class="form-group__bar"></i>
                </div>
                
                <div class="form-group">
                    <input type="text" name="city" value="{{ isset($company->city) ? $company->city : '' }}" class="form-control" placeholder="City">
                    <i class="form-group__bar"></i>
                </div>
                
                <div class="form-group">
                    <input type="text" name="state" value="{{ isset($company->state) ? $company->state : '' }}" class="form-control" placeholder="State">
                    <i class="form-group__bar"></i>
                </div>
                
                <div class="form-group">
                    <input type="text" name="zip" value="{{ isset($company->zip) ? $company->zip : '' }}" class="form-control" placeholder="Zip Code">
                    <i class="form-group__bar"></i>
                </div>
